...
// Now, convert the result to a sorted List<DayInMonthStatistic2>
    ...
    @Override
    public StatisticDate getStatisticDate(Date date1, Date date2) {
        Long amount1 = billRepository.doanhThuNgay(date1);
        Long amount2 = billRepository.doanhThuNgay(date2);

        return new StatisticDate(date1, date2, amount1, amount2);
    }
