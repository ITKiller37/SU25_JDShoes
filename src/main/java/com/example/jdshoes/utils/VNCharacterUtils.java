...
public class VNCharacterUtils {
    ...
    public static String buildAccountInfoEmail(String userEmail, String password) {
        return "<!DOCTYPE html>\n" +
                "<html>\n" +
                "<head>\n" +
                "    <meta charset=\"UTF-8\">\n" +
                ...
                "        .info { background-color: #f0f0f0; padding: 10px; border-radius: 5px; margin-top: 10px; }\n" +
                ...
                "        <div class=\"info\">\n" +
                "            <p><span class=\"label\">Email đăng nhập:</span> " + userEmail + "</p>\n" +
                "            <p><span class=\"label\">Mật khẩu:</span> " + password + "</p>\n" +
                "        </div>\n" +
                "        <p>Vui lòng giữ thông tin này cẩn thận và không chia sẻ với người khác.</p>\n" +
                "    </div>\n" +
                "</body>\n" +
                "</html>";
    }
